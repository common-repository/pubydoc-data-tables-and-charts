...
abstract class ViewPyt extends BaseObjectPyt {
	/*
	 * @deprecated
	 */
	protected $_tpl = PYT_DEFAULT;
	/*
	...
	public function display( $tpl = '' ) {
		...
		if (false !== $content) {
			HtmlPyt::echoEscapedHtml($content);
		}
	}
	public function getPath( $tpl ) {
		$path = '';
		$parentModule = FramePyt::_()->getModule( $this->_code );
	...
	public function getModel( $code = '' ) {
		return FramePyt::_()->getModule( $this->_code )->getController()->getModel($code);
	}
